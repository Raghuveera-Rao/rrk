...
public void start(boolean wait) {
    Futures.getAndHandleExceptions(deployBookkeeperUsingOperator(zkUri, DEFAULT_BOOKIE_COUNT, properties),
        ...
        return k8sClient.getCustomObject(CUSTOM_RESOURCE_GROUP_BOOKKEEPER, CUSTOM_RESOURCE_VERSION_BOOKKEEPER, NAMESPACE, CUSTOM_RESOURCE_PLURAL_BOOKKEEPER, BOOKKEEPER_ID)
                .thenCompose(o -> {
                    ...
                    if (currentBookkeeperCount != newInstanceCount) {
                        final Map<String, Object> patchedSpec = buildPatchedBookkeeperClusterSpec("replicas", newInstanceCount, "bookkeeper");
